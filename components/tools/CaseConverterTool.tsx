  ...
  return (
    <div className="w-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden transition-all">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-3.5 border-b border-slate-200/80 dark:border-slate-800/80 bg-slate-50/80 dark:bg-slate-950/60">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-300 hover:bg-slate-200/60 dark:hover:bg-slate-800 transition-colors"
          >
          ...
          <button
            ...
            onClick={handleClear}
            disabled={!text}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
            <button
              ...
              disabled={!text}
              className={`px-4 py-3 rounded-xl text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-150 border cursor-pointer ${
            ...
            <button
              ...
              disabled={!text}
              className={`px-4 py-3 rounded-xl text-xs sm:text-sm font-medium lowercase tracking-wide transition-all duration-150 border cursor-pointer ${
            ...
            <button
              ...
              disabled={!text}
              className={`px-4 py-3 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-150 border cursor-pointer ${
            ...
            <button
              ...
              disabled={!text}
              className={`px-4 py-3 rounded-xl text-xs sm:text-sm font-medium transition-all duration-150 border cursor-pointer ${
                activeCase === "Sentence case"
                  ? "bg-indigo-600 text-white border-indigo-600 shadow-md shadow-indigo-600/25 ring-2 ring-indigo-500/20"
                  : "bg-slate-100 dark:bg-slate-800/80 text-slate-800 dark:text-slate-200 border-slate-200 dark:border-slate-700/80 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-300 dark:hover:border-indigo-600/40 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed"
              }`}
            >
          ...
          <div className="pt-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
              ...
              <button
                ...
                disabled={!text}
                className={`col-span-2 sm:col-span-1 px-3 py-2 rounded-lg text-xs font-mono transition-all border cursor-pointer ${
                  activeCase === "CONSTANT_CASE"
                    ? "bg-indigo-600 text-white border-indigo-600"
                    : "bg-slate-50 dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed"
                }`}
              >
        ...
        {/* Action Row: Copy to Clipboard button with Toast feedback */}
        <div className="mt-8 pt-5 border-t border-slate-200/80 dark:border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="w-full sm:w-auto flex items-center justify-end gap-3">
            {copied && (
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/80 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60 animate-fade-in">

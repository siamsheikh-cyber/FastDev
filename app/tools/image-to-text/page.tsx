...
export const metadata: Metadata = {
  title: "Free Image to Text Converter Online (OCR)",
  description:
    "Extract clean text and code from images, screenshots, and scanned documents in your browser. Free client-side OCR tool with zero server uploads and 100% privacy.",
  keywords: [
  ...
  openGraph: {
    title: "Free Image to Text Converter Online (OCR) | FearDev",
    description:
        ...
        <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-indigo-900 via-slate-900 to-indigo-950 p-8 sm:p-10 text-white text-center space-y-4 shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold bg-white text-slate-900 hover:bg-slate-100 transition-colors shadow-sm cursor-pointer"
            >
              <span>Case Converter</span>
            </Link>
            <Link
              href="/tools/fiverr-word-checker"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold bg-indigo-600 hover:bg-indigo-500 text-white transition-colors shadow-sm cursor-pointer"
            >
